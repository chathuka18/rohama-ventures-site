...
export default function FAQ() {
  ...
  return <>
    <PageHero eyebrow="FAQ" title="Clear answers before we get started." body="A practical overview of how ROHAMA Ventures works, the clients we support and what to expect from an engagement." image={siteImages.planExecuteGrow} />
